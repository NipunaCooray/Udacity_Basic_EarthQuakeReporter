...
public class SingleItemAdapter extends ArrayAdapter<Earthquake> {
    private static final String LOG_TAG = SingleItemAdapter.class.getSimpleName();
     ...
     */
    public SingleItemAdapter(Activity context, ArrayList<Earthquake> words) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String formattedMagnitude = formatter.format(currentItem.getMagnitude());
